...
TEST_PAIRS = [
    ...
    (7, 0, "3-hop-up"), # sensor8 -> root
    (0, 8, "3-hop-b2"), # root -> sensor9 (branch 2)
    (0, 9, "3-hop-b3"), # root -> sensor10 (branch 3)
]
...
def create_topology():
    ...
    info("  Waiting 10s for all interfaces to come up...\n")
    time.sleep(10)
...
def print_summary(all_results):
    ...
    for mode in ["storing", "nonstoring", "hybrid"]:
        ...
        print("  Lat 3-hop up:    {}ms".format(stat("8to1_lat_avg")))
